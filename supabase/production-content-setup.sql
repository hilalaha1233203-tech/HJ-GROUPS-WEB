-- HJ GROUPS production content repair / setup
-- Run this ONCE in the Web Player's Supabase SQL Editor.
-- This is safe to re-run: tables/columns/policies are created only when absent.
...
-- Older database versions used episode_number/audio_url.
update public.episodes
set number = coalesce(number, episode_number),
    file_url = coalesce(file_url, audio_url)
