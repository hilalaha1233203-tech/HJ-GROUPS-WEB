...
.hj-reader-extra-controls{position:relative;grid-column:1/-1;display:flex;align-items:center;justify-content:center;gap:7px;flex-wrap:wrap;min-width:0;order:4}.hj-reader-tools{position:static;z-index:1;display:flex;align-items:center;gap:7px;padding:8px 10px;border:1px solid rgba(124,131,255,.28);border-radius:14px;background:rgba(14,16,28,.96);backdrop-filter:blur(14px);box-shadow:0 10px 30px rgba(0,0,0,.28);font:500 12px/1.2 system-ui,sans-serif;color:#e9ebff}
...
.hj-tts-panel{position:absolute;left:50%;bottom:calc(100% + 6px);transform:translateX(-50%);z-index:100053;width:280px;padding:15px;border:1px solid rgba(124,131,255,.3);border-radius:16px;background:rgba(14,16,28,.98);backdrop-filter:blur(18px);box-shadow:0 16px 42px rgba(0,0,0,.4);font:500 12px/1.35 system-ui,sans-serif;color:#eef0ff;display:none}
